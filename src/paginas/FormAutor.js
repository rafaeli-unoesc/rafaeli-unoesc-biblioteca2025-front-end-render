...
export default function FormAutor() {
    ...
    const selecionar = async () => {
        let { data } = await axios.get(`https://biblioteca2025-back-end-render.onrender.com/autor/${id}`);
    ...
    const alterar = async () => {
        ...
        await axios.put(`https://biblioteca2025-back-end-render.onrender.com/autor/${id}`, body);
        voltar();
    }
    ...
    const inserir = async () => {
        ...
        await axios.post(`https://biblioteca2025-back-end-render.onrender.com/autor`, body);
        voltar();
    }
    ...
    const excluir = async () => {
        await axios.delete(`https://biblioteca2025-back-end-render.onrender.com/autor/${id}`);
        voltar();
    }
